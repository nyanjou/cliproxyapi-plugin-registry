...
- A provisional `v0.2.0` setup-installer release was withdrawn after an isolated external-plugin ABI test found its management route registration could not decode. It is not available through this registry.
